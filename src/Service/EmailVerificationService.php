...
class EmailVerificationService
{
    ...
    public function sendVerificationEmail(User $user, string $verificationUrl): void
    {
        $email = (new TemplatedEmail())
            ->from(new Address('bealynpacunla93@gmail.com', 'Pacunla School Supplies and Stationery')) // Change this to verified sender
    ...
    public function verifyToken(string $token): ?User
    {
        ...
        $user->setVerificationToken(null); // Clear the token now that the column allows NULL
